...
class Typer:
    ...
    def visit_builint(self, func_id: BuiltIn, *arguments: Node):
        ...
        if func_id == bi_div:
            ...
            elif lhs_type == type_string == rhs_type:
                return type_string
            else:
    ...
    def visit_var_def(self, varDef: VarDef):
        ...
        self.constaints.append(IsType(t, varDef.value.visit(self), varDef.span))
    ...
    def _check_with_mapping(
        ...
        for idx, constraint in enumerate(constaints):
            ...
            res, c_err_string = self._check_with_mapping(
                constaints[idx + 1 :], new_mapping
            )
            if res != 0:
                err += 1
